            ...
            for row in rows:
                writer.writerow({
                    ...
                    for key, value in {
                        ...
                        "user_context_json": row.get("user_context_json", "{}"),
        ...
        for row in rows:
            values.append([
                ...
                for value in [
                    ...
                    str(row.get("pain_type", "unknown")),
                    str(row.get("expression_type", "unknown")),
                    str(row.get("user_context_json", "{}")),
                    str(row.get("intensity_score", 0)),
                    str(row.get("frequency_signal", "single")),
                    str(row.get("urgency", "none")),
                    str(row.get("current_workaround", "")),
                    str(row.get("wtp_score", 0)),
                    str(row.get("incumbent_failure", "")),
                    str(row.get("opportunity_type", "unknown")),
                    str(row.get("opportunity_score", 0)),
                    str(row.get("score_components_json", "{}")),
