...
if PRIMARY_MAX_OUTPUT_TOKENS > LLM_MAX_TOKENS:
    raise ValueError("PRIMARY_MAX_OUTPUT_TOKENS must be less than or equal to LLM_MAX_TOKENS")
...
SCRAPER_MAX_RESPONSE_BYTES = _int_min_env("SCRAPER_MAX_RESPONSE_BYTES", 5_000_000, 1024)
...
DSPY_TIMEOUT_SECONDS = _float_min_env("DSPY_TIMEOUT_SECONDS", 60.0, 0.1)
...
HN_MAX_RESPONSE_BYTES = _int_min_env("HN_MAX_RESPONSE_BYTES", 2_000_000, 1024)
...
REVIEWS_MAX_HTML_BYTES = _int_min_env("REVIEWS_MAX_HTML_BYTES", 2_000_000, 1024)
...
_valid_review_targets = [
    target for target in _enabled_review_targets if is_public_http_url(str(target.get("url") or ""))
]
